...
int main() {
    ...
    struct packaged_double * su_rtl=(struct packaged_double *) malloc(sizeof(struct packaged_double) * field_x * field_y * size_z);
    struct packaged_double * sv_rtl=(struct packaged_double *) malloc(sizeof(struct packaged_double) * field_x * field_y * size_z);
    struct packaged_double * sw_rtl=(struct packaged_double *) malloc(sizeof(struct packaged_double) * field_x * field_y * size_z);
    struct packaged_double * u_rtl=(struct packaged_double *) malloc(sizeof(struct packaged_double) * field_x * field_y * size_z);
    struct packaged_double * v_rtl=(struct packaged_double *) malloc(sizeof(struct packaged_double) * field_x * field_y * size_z);
    struct packaged_double * w_rtl=(struct packaged_double *) malloc(sizeof(struct packaged_double) * field_x * field_y * size_z);
    double * tzc1_rtl=(double *) malloc(sizeof(double) * size_z);
    double * tzc2_rtl=(double *) malloc(sizeof(double) * size_z);
    double * tzd1_rtl=(double *) malloc(sizeof(double) * size_z);
    double * tzd2_rtl=(double *) malloc(sizeof(double) * size_z);

    int i;
    int packed_counter = 0;
    srand(42);
    int total_elements = field_x * field_y * size_z;
    ...
    print_3d_array(su, field_x, field_y, size_z, "cpu_su_output.txt");
    print_3d_array_packed(su_rtl, field_x, field_y, size_z, "rtl_su_output.txt");
